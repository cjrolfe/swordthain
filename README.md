...
Each app is its own deployable unit with its own README/CLAUDE.md and, eventually, its own CDK stack — changes to one shouldn't require touching the other. Shared infra (Cognito user pool, WAF Web ACL, Route 53 hosted zone) is provisioned separately and referenced by both.
